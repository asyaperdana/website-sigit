...
<section id="reviews" class="max-w-6xl mx-auto px-6 py-24 reveal">
	...
	<div class="grid lg:grid-cols-12 gap-12 items-start">
		...
		<div class="lg:col-span-5 space-y-8">
			<div class="glass p-8 border border-white/5 relative overflow-hidden group">
				...
				<form onsubmit={handleSubmit} class="space-y-6">
					{#if showSuccess}
						...
						>
							...
							<span class="text-sm font-medium">Review berhasil dikirim! Makasih ya! 🙏</span>
						</div>
					{/if}
					...
					<div class="space-y-3">
						<label
							for="rating-input"
							class="text-xs font-bold uppercase tracking-widest text-indigo-400">Rating Mu</label
						>
					...
					<div class="space-y-3">
						<label
							for="userName"
							class="text-xs font-bold uppercase tracking-widest text-indigo-400">Nama</label
						>
						<input
							id="userName"
							type="text"
					...
					<div class="space-y-3">
						<label for="comment" class="text-xs font-bold uppercase tracking-widest text-indigo-400"
							>Kesan Pesan</label
						>
						<textarea
							id="comment"
		...
		<div class="lg:col-span-7 flex flex-col h-[700px]">
			...
			<div class="flex-1 overflow-y-auto space-y-4 pr-4 custom-scrollbar scroll-smooth">
