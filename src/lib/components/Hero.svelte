...
>
	...
	<div class="relative z-10 px-6 max-w-5xl">
		...
		>
			Blending <span class="text-[var(--text)] font-normal">artistic vision</span>
			with
			<span class="text-[var(--text)] font-normal">technical precision</span> to build the web of tomorrow.
		</p>
	...
	>
		...
		<div class="w-px h-10 bg-gradient-to-b from-indigo-500 to-transparent"></div>
	</div>
</header>
